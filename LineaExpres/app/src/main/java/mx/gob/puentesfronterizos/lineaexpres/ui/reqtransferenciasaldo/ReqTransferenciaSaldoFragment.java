...
import mx.gob.puentesfronterizos.lineaexpres.databinding.FragmentReqTransferenciaSaldoBinding;
...
public class ReqTransferenciaSaldoFragment extends Fragment {
    ...
    private FragmentReqTransferenciaSaldoBinding binding;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        ReqTransferenciaSaldoViewModel cambioVehiculoFragment =
                new ViewModelProvider(this).get(ReqTransferenciaSaldoViewModel.class);

        binding = FragmentReqTransferenciaSaldoBinding.inflate(inflater, container, false);
       ...
       EditText tagNewVehiculo = binding.tagNewVehiculo;
       EditText marcaNewVehiculo = binding.marcaNewVehiculo;
       EditText ModeloNewVehiculo = binding.ModeloNewVehiculo;
       EditText ColorNewVehiculo = binding.ColorNewVehiculo;
       EditText AnioNewVehiculo = binding.AnioNewVehiculo;
       EditText PlacasNewVehiculo = binding.PlacasNewVehiculo;
        ...
        AnioNewVehiculo.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL);
        ...
        btnSendForm.setOnClickListener(v -> {
            ...
            sendRequest(tagNewVehiculo.getText().toString(), marcaNewVehiculo.getText().toString(), ModeloNewVehiculo.getText().toString(), ColorNewVehiculo.getText().toString(), AnioNewVehiculo.getText().toString(), PlacasNewVehiculo.getText().toString());
        });
    ...
    public void sendRequest(String tag, String marca, String modelo, String color, String anio, String placas) {
        new Thread(() -> {
            try {

                InputStream inputStream;
                String url_process = getResources().getString(R.string.apiURL) + "api/v1/procs/p04";
                ...
                jsonParam.put("num_tag1", num_tag);
                ...
                jsonParam.put("num_tag2", tag);
                jsonParam.put("veh2_marca", marca);
                jsonParam.put("veh2_modelo", modelo);
                jsonParam.put("veh2_color", color);
                jsonParam.put("veh2_anio", anio);
                jsonParam.put("veh2_placas", placas);
