...
import mx.gob.puentesfronterizos.lineaexpres.databinding.FragmentReqCambioConvenioBinding;
...
public class ReqCambioConvenioFragment extends Fragment {
    ...
    private FragmentReqCambioConvenioBinding binding;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        ReqCambioConvenioViewModel cambioVehiculoFragment =
                new ViewModelProvider(this).get(ReqCambioConvenioViewModel.class);

        binding = FragmentReqCambioConvenioBinding.inflate(inflater, container, false);
        ...
        OriginVehTitle.setText("Usted está bajo el siguiente convenio -" + tipoConvenioInformativo + "- y puede cambiarlo a");
