    ...
    public void checkSentri(String sentri) {
        ...
        new Thread(() -> {
            try {
                ...
                String accountActivation_url = getResources().getString(R.string.apiURL) + "api/v1/le/user/"+sentri+"/"+User+"";
    ...
    public void uploadVeh(String sentri) {
        ...
        new Thread(() -> {
            try {
                ...
                InputStream inputStream;
                String url_process = getResources().getString(R.string.apiURL) + "api/v1/user/sentri";
