...
import mx.gob.puentesfronterizos.lineaexpres.databinding.FragmentReqBajaVehiculoBinding;
...
public class ReqBajaVehiculoFragment extends Fragment {
    ...
    String Nacionalidad;
    String PuenteAdscripcion;

    String ZaragozaIntSelected;
    String LerdoIntSelected;
    ...
    private FragmentReqBajaVehiculoBinding binding;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        ReqBajaVehiculoViewModel cambioVehiculoFragment =
                new ViewModelProvider(this).get(ReqBajaVehiculoViewModel.class);

        binding = FragmentReqBajaVehiculoBinding.inflate(inflater, container, false);
        ...
        EditText MotivoBaja = binding.getWhyExplain;

        Button BtnOriginNational = binding.btnNewVehiculeOriginNational;
        Button BtnOriginUSA = binding.btnNewVehiculeOriginUSA;

        //Circulation Card ---
        Button btnAdscripcionZaragoza = binding.btnAdscripcionZaragoza;
        Button btnAdscripcionLerdo = binding.btnAdscripcionLerdo;
        ...
        btnAdscripcionZaragoza.setOnClickListener(v -> {
            PuenteAdscripcion = "Zaragoza";
            ZaragozaIntSelected = "1";
            LerdoIntSelected = "0";
            btnAdscripcionLerdo.setBackgroundResource(R.drawable.buttons2);
            btnAdscripcionZaragoza.setBackgroundResource(R.drawable.buttons);
        });

        btnAdscripcionLerdo.setOnClickListener(v -> {
            PuenteAdscripcion = "Lerdo";
            ZaragozaIntSelected = "0";
            LerdoIntSelected = "1";
            btnAdscripcionZaragoza.setBackgroundResource(R.drawable.buttons2);
            btnAdscripcionLerdo.setBackgroundResource(R.drawable.buttons);
        });
        ...
        btnSendForm.setOnClickListener(v -> {
            ...
            sendRequest(MotivoBaja.getText().toString());
        });
    ...
    public void sendRequest(String MotivoBaja) {
        new Thread(() -> {
            try {

                InputStream inputStream;
                String url_process = getResources().getString(R.string.apiURL) + "api/v1/procs/p05";
                ...
                jsonParam.put("veh_origen", Nacionalidad);
                jsonParam.put("motivo", MotivoBaja);
                jsonParam.put("veh_adscrip_zaragoza", ZaragozaIntSelected);
                jsonParam.put("veh_adscrip_lerdo", LerdoIntSelected);
