...
import mx.gob.puentesfronterizos.lineaexpres.databinding.FragmentReqCambioTagBinding;
...
public class ReqCambioTagFragment extends Fragment {
    ...
    ReqCambioTagViewModel cambioVehiculoFragment =
        ...
        TextView getWhyExplain = binding.getWhyExplain;
        ...
        btnSendForm.setOnClickListener(v -> {
            ...
            sendRequest(getWhyExplain.getText().toString());
        });
