...
import mx.gob.puentesfronterizos.lineaexpres.databinding.FragmentReqChangeVehicleBinding;
...
import mx.gob.puentesfronterizos.lineaexpres.ui.reqbridges.ReqBridgesFragment;
...
public class ReqChangeVehicleFragment extends Fragment {
    ...
    private FragmentReqChangeVehicleBinding binding;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        ReqChangeVehicleViewModel reqInscriptionViewModel = new ViewModelProvider(this).get(ReqChangeVehicleViewModel.class);

        binding = FragmentReqChangeVehicleBinding.inflate(inflater, container, false);
        ...
        sendFormBtn.setOnClickListener(v -> {
            ...
            bitmapToFile(requireContext(), sign, "Solicitud_CambioVeh_Firma.png");
            popupWindow.showAtLocation(view, Gravity.CENTER, 0, 0);
            SendReqInscription(Sentri, SentriExp, fac_razon_social, fac_rfc, fac_dom_fiscal, fac_email, fac_telefono, num_tag, veh1_brand, veh1_model, veh1_color, veh1_year, veh1_plates, veh1_orig, veh2_brand, veh2_model, veh2_color, veh2_year, veh2_plates, veh2_orig, Token);
    ...
    public void SendReqInscription(String sentri, String SentriExp, String fac_razon_social, String fac_rfc, String fac_dom_fiscal, String fac_email, String fac_telefono, String num_tag, String veh1_brand, String veh1_model, String veh1_color, String veh1_year, String veh1_plates, String veh1_orig, String veh2_brand, String veh2_model, String veh2_color, String veh2_year, String veh2_plates, String veh2_orig, String token){
        new Thread(() -> {
            try {
                ...
                if (messageRes.contains("registrado")) {
                    ...
                    requireActivity().runOnUiThread(() -> {
                        ...
                        TarjetaCirculacionPhotoImageView.setVisibility(View.GONE);
                        PolizaSeguroPhotoImageView.setVisibility(View.GONE);
                        AprovacionUSAPhotoImageView.setVisibility(View.GONE);
                        CartaPoderPhotoImageView.setVisibility(View.GONE);
                        ...
                        TarjetaCirculacionPhotoImageView.setImageResource(0);
                        PolizaSeguroPhotoImageView.setImageResource(0);
                        AprovacionUSAPhotoImageView.setImageResource(0);
                        CartaPoderPhotoImageView.setImageResource(0);
        ...
        new Thread(() -> {
            try {
                ...
                RequestBody requestBody = new MultipartBody.Builder()
                        ...
                        .addFormDataPart("id_proc_type", "3")
                        .build();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (data.getData() != null) {
                ...
                try {
                    bitmap = rotateImage(MediaStore.Images.Media.getBitmap(requireActivity().getContentResolver(), Uri.parse(selectedImage)), 0);
