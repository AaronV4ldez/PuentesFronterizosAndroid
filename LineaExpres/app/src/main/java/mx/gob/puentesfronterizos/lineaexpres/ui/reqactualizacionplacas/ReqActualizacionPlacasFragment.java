...
import mx.gob.puentesfronterizos.lineaexpres.databinding.FragmentReqActualizacionPlacasBinding;
...
public class ReqActualizacionPlacasFragment extends Fragment {
    ...
    private FragmentReqActualizacionPlacasBinding binding;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        ReqActualizacionPlacasViewModel cambioVehiculoFragment =
                new ViewModelProvider(this).get(ReqActualizacionPlacasViewModel.class);

        binding = FragmentReqActualizacionPlacasBinding.inflate(inflater, container, false);
        ...
        EditText newPlates = binding.getWhyExplain;
        ...
        btnSendForm.setOnClickListener(v -> {
            ...
            sendRequest(newPlates.getText().toString());
        });
    ...
    public void sendRequest(String newPlates){
        new Thread(() -> {
            try {
                ...
                jsonParam.put("veh2_placas", newPlates);
