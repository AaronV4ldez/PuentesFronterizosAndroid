...
public class dbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE " + uriTramites + " (id INTEGER NOT NULL, Photo_Sentri TEXT, Photo_Sentri2 TEXT, Photo_idOficial TEXT, Photo_idOficialReverse TEXT, Photo_idOficialReverse2 TEXT, Photo_tarjetaCirculacion TEXT, Photo_polizaSeguro TEXT, Photo_polizaSeguro2 TEXT, Photo_AprovacionUSA TEXT, Photo_cartaPoder TEXT, FIRMA TEXT)" );
