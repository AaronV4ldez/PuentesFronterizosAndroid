package mx.gob.puentesfronterizos.lineaexpres.ui.reqbajatag;
...
import mx.gob.puentesfronterizos.lineaexpres.databinding.FragmentReqBajaTagBinding;
...
public class ReqBajaTagFragment extends Fragment {
    ...
    private FragmentReqBajaTagBinding binding;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        ReqBajaTagViewModel cambioVehiculoFragment =
                new ViewModelProvider(this).get(ReqBajaTagViewModel.class);

        binding = FragmentReqBajaTagBinding.inflate(inflater, container, false);
    ...
    public void sendRequest(String MotivoBaja) {
        new Thread(() -> {
            try {
                ...
                jsonParam.put("comments", MotivoBaja);
