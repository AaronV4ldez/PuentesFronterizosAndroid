...
import mx.gob.puentesfronterizos.lineaexpres.databinding.FragmentCurrentCitasBinding;
...
public class CurrentCitasFragment extends Fragment {
    ...
    private FragmentCurrentCitasBinding binding;
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        CurrentCitasViewModel FormalitiesViewModel = new ViewModelProvider(this).get(CurrentCitasViewModel.class);
        binding = FragmentCurrentCitasBinding.inflate(inflater, container, false);
